        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container">
                    <a style="text-decoration:none; color: inherit;" href="usuarioFormulario.php?tipo=cliente"><button class="btn btn-info col-12 col-md-3 mt-2 mb-2">Alta de Cliente</button></a>
                    </div>
                    <table class="table">
                        <thead>
                          <tr>
