...
<html lang="en-US" dir="ltr">
  ...
  <body>
    ...
    <main class="main" id="top">
      ...
      <section class="py-10 bg-light-gradient border-bottom border-white border-5">
          ...
          <div class="row flex-center">
            <div class="col-12 mb-10">
              <div class="d-flex align-items-center flex-column">
                ...
                <div class="col-12 d-flex justify-content-center mt-5"> <a class="btn btn-lg btn-dark" href="shop.php">Compra Ya!</a></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
          <div class="row h-100">
            ...
            <div class="col-12 d-flex justify-content-center mt-5"> <a class="btn btn-lg btn-dark" href="shop.php">Ver todos </a></div>
          </div>
        </div>
        <!-- end of .container-->
              ...
              <?php mysqli_data_seek($nuevos, 0); while ($row = mysqli_fetch_array($nuevos)): ?>
                      ...
                      <a href="item.php?id_inventario=<?= $row['id_inventario'] ?>">
                        <div class="card card-span h-100 text-white">
                          ...
                          </div><a class="stretched-link" href="login.php"></a>
                        </div>
                        </a>
                      </div>
                <?php endwhile; ?>
