                ...
                <div class="p-5">
                    ...
                    <form class="user">   
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                              <p><strong>Apellido Paterno:</strong> <?= $row ['app'] ?></p>
                            </div>
                            <div class="col-sm-4">
                              <p><strong>Apellido Materno:</strong> <?= $row ['apm'] ?></p>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-4">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                              <p><strong>Contraseña:</strong> <?= str_repeat('*', strlen($row['psw'])) ?></p>
                            </div>
                        </div>
                        <a style="text-decoration:none; color: inherit;" href="php/update.php?id_usuario=<?php echo $id; ?>"><input type="button" class="btn btn-primary btn-user btn-block" value="Modificar"></a>
                        <br><br>
                        <a data-toggle="modal" data-target="#delete" style="text-decoration:none; color: inherit;"><input type="button" class="btn btn-danger btn-user btn-block" value="Eliminar cuenta"></a>
                    </form>
                    <hr>
                </div>
            </div>
    ...
    <div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Confirma que deseas eliminar tu cuenta.</div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancelar</button>
                    <a class="btn btn-danger" href="php/delete_user.php?id_usuario=<?php echo $id; ?>">Eliminar</a>
                </div>
            </div>
        </div>
    </div>
