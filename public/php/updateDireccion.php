...
$sql = "SELECT * FROM direccionenvio WHERE id_direccion='$id'";
...
if(isset($_POST['guardar'])){
    ...
    $cp = $_POST['cp'];
    mysqli_query($con, "UPDATE direccionenvio 
    SET 
    calle = '$calle', 
    colonia = '$colonia', 
    numero_exterior = '$num', 
    cp = '$cp'
    WHERE id_direccion = '$id_direccion'") or die('query failed');
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form method="POST" class="row g-3 p-4 pt-0">
                                <input type="hidden" class="form-control" name="id_direccion" value="<?= $row ['id_direccion'] ?>">
                                ...
                                <div class="col-12 mt-4">
                                    ...
                                    <input type="text" class="form-control" name="colonia" value="<?= $row ['colonia'] ?>">
                                </div>
                                <div class="col-6 mt-4">
                                <label for="inputRFC" class="form-label">No. exterior</label>
                                <input type="text" class="form-control" name="numero_exterior" value="<?= $row ['numero_exterior'] ?>" >
                                </div>
                                <div class="col-6 mt-4">
                                <label for="razonSocial" class="form-label">CP</label>
                                <input type="text" class="form-control" name="cp" value="<?= $row ['cp'] ?>">
                                </div>
