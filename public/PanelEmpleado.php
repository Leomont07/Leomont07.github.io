<?php
    ...
    if(isset($_POST['clientes'])){
        ...
        if(empty($cliente)){
            ...
            $sql = "SELECT * FROM Usuario WHERE tipo = 'cliente' AND nombre='$cliente'" ;
...
<div class="container-fluid">
  ...
  <div class="container">
  <button class="btn btn-info col-12 col-md-3 mt-2 mb-2"><a style="text-decoration:none; color: inherit;" href="usuarioFormulario.php?tipo=cliente">Alta de Cliente</a></button>
  </div>
  <table class="table">
      <thead>
        <tr>
