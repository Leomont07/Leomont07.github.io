<?php
    ...
    if(isset($_POST['clientes'])){
        ...
        if(empty($cliente)){
            $sql = "SELECT u.id_usuario, u.nombre, u.app, u.apm, u.correo, s.nombre AS sucursal
            FROM Usuario u
            INNER JOIN sucursal s ON u.id_sucursal = s.id_sucursal
            WHERE tipo = 'empleado'
            GROUP BY u.id_usuario, u.nombre, u.app, u.apm, u.correo, s.nombre " ;
            ...
            FROM Usuario u
            INNER JOIN sucursal s ON u.id_sucursal = s.id_sucursal 
            WHERE tipo = 'empleado' AND nombre='$cliente'
            GROUP BY u.id_usuario, u.nombre, u.app, u.apm, u.correo, s.nombre" ;
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container">
                    <button class="btn btn-info col-12 col-md-3 mt-2 mb-2"><a style="text-decoration:none; color: inherit;" href="usuarioFormulario.php?tipo=empleado">Alta de Empleado</a></button>
                    </div>
                    <table class="table">
                        <thead>
                          <tr>
