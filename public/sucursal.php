...
<html lang="en-US" dir="ltr">
  ...
  <body>
          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
              <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item px-2"><a class="nav-link fw-medium" href="sucursal.html">Sucursales</a></li>
                <li class="nav-item px-2"><a class="nav-link fw-medium" href="#">Contacto</a></li>
              </ul>
    ...
    <main class="main" id="top">
      ...
      <section class="py-11">   
        <div class="bg-holder overlay overlay-0" style="background-image:url(assets/img/gallery/bg1.png);background-position:center;background-size:cover;">
        </div>
        <!--/.bg-holder-->
                    ...
                    <div class="row h-100 align-items-center g-2">
                      <div class="col-12">
                        <div class="text-light text-center py-2">
                          <h5 class="display-4 fw-normal text-400 fw-normal mb-4">Sucursal</h5>
                          <h1 class="display-1 text-white fw-normal mb-8">GDL</h1><a class="btn btn-lg text-light fs-1" href="shop.html" role="button">Ir
                            <svg class="bi bi-arrow-right-short" xmlns="https://drive.google.com/file/d/1XCud5ENbp0SE0gTi8CGExOiF_R1Wq4Uk/view?usp=drive_link" width="23" height="23" fill="currentColor" viewBox="0 0 16 16">
                  ...
                  <div class="carousel-item" data-bs-interval="5000">
                    <div class="row h-100 align-items-center g-2">
                      <div class="col-12">
                        <div class="text-light text-center py-2">
                          <h5 class="display-4 fw-normal text-400 fw-normal mb-4">Sucursal</h5>
                          <h1 class="display-1 text-white fw-normal mb-8">CDMX</h1><a class="btn btn-lg text-light fs-1" href="shop.html" role="button">Ir
                            <svg class="bi bi-arrow-right-short" xmlns="https://drive.google.com/file/d/1XCud5ENbp0SE0gTi8CGExOiF_R1Wq4Uk/view?usp=drive_link" width="23" height="23" fill="currentColor" viewBox="0 0 16 16">
                              <path fill-rule="evenodd" d="M4 8a.5.5 0 0 1 .5-.5h5.793L8.146 5.354a.5.5 0 1 1 .708-.708l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L10.293 8.5H4.5A.5.5 0 0 1 4 8z"> </path>
                            </svg></a>
                        </div>
                  ...
                  <div class="carousel-item" data-bs-interval="3000">
                    <div class="row h-100 align-items-center g-2">
                      <div class="col-12">
                        <div class="text-light text-center py-2">
                          <h5 class="display-4 fw-normal text-400 fw-normal mb-4">Sucursal</h5>
                          <h1 class="display-1 text-white fw-normal mb-8">QRO</h1><a class="btn btn-lg text-light fs-1" href="shop.html" role="button">Ir
                            <svg class="bi bi-arrow-right-short" xmlns="https://drive.google.com/file/d/1XCud5ENbp0SE0gTi8CGExOiF_R1Wq4Uk/view?usp=drive_link" width="23" height="23" fill="currentColor" viewBox="0 0 16 16">
                              <path fill-rule="evenodd" d="M4 8a.5.5 0 0 1 .5-.5h5.793L8.146 5.354a.5.5 0 1 1 .708-.708l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L10.293 8.5H4.5A.5.5 0 0 1 4 8z"> </path>
                            </svg></a>
                        </div>
